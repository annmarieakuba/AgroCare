...
<head>
    ...
    <style>
        ...
        #cartFeedback .alert-success::before {
            background: linear-gradient(180deg, #16a34a, #0f9b4c);
        }

        #cartFeedback .alert-danger::before {
            background: linear-gradient(180deg, #dc2626, #b91c1c);
        }

        #cartFeedback .alert-info::before {
            background: linear-gradient(180deg, #0ea5e9, #0284c7);
        }

        #cartFeedback .alert .btn-close {
            margin-left: auto;
            filter: invert(0.5);
        }
    </style>
